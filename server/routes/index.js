...
let categoryCtrl = require("../controllers/employee.controller");
...
router.post('/save-movie', function (req, res) {
    return categoryCtrl.saveMovie(req, res)
});
//routes for Employees
router.get('/get-all-employees', function (req, res) {
    return categoryCtrl.getAllEmployess(req, res)
});
router.post('/save-employee', function (req, res) {
    return categoryCtrl.saveEmployee(req, res)
});
